...
const es: Translation = {
    ...
    commands: {
        ...
        pingAlive: {
            description: 'Are you alive ping for associates',
            ...
            responseModalTipValue: '[Solo lectura]\n>>>Si es posible, solicite las emisoras que se utilizan en los días extra según sea necesario.<<<',
